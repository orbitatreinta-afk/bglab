  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-20 bg-ibta-primary flex items-center justify-center py-3 lg:py-12">
          <h2 className="text-white font-bold text-sm md:text-base lg:text-lg lg:writing-mode-vertical lg:-rotate-180 whitespace-nowrap tracking-wider uppercase lg:py-8">
            Quienes Somos
          </h2>
        </div>

        {/* Contenido */}
        <div className="flex-1 px-4 md:px-8 lg:px-16 py-8 md:py-12 lg:py-16">
